        ...
        <b-row>
                ...
                <div class="card">
                    ...
                    <div class="shadow border-left-primary py-2">
                        <div class="card-header" style="padding: 3px;">
                            <h1 class="text-center" style="font-size: 15px;margin: 0px;color: rgb(197,159,52);width: 100%;"><br>{{$t('Common.Vision')}}<br><br></h1>
                        </div>
                        <div class="card-body">
                            <b-progress :max="VisionMax">
                                <b-progress-bar :value="VisionValue" :label="`${((VisionValue / VisionMax) * 100).toFixed(2)}%`"></b-progress-bar>
                            </b-progress>
                            <p v-if="VisionValue / VisionMax == 1" class="sueccess text-center">Finshed</p>
                        </div>
                    </div>
            ...
            <a v-if="workBook>1" class="col-md-6 col-xl-3 mb-4" @click="routTo('Habit')">
                <div class="card">
                    ...
                    <div class="shadow border-left-primary py-2">
                        <div class="card-header" style="padding: 3px;">
                            <h1 class="text-center" style="font-size: 15px;margin: 0px;color: rgb(197,159,52);width: 100%;"><br>{{$t('Common.Habit')}}<br><br></h1>
                        </div>
                        <div class="card-body">
                            <b-progress :max="HabitMax">
                                <b-progress-bar :value="HabitValue" :label="`${((HabitValue / HabitMax) * 100).toFixed(2)}%`"></b-progress-bar>
                            </b-progress>
                            <p v-if="HabitValue / HabitMax == 1" class="sueccess text-center">Finshed</p>
                        </div>
            ...
            <a v-if="workBook>2" class="col-md-6 col-xl-3 mb-4" @click="routTo('MindProgramming')">
                <div class="card">
                    <img src="@/assets/img/reprogram-subconscious-mind.jpg" style="width: 100%;" height="150em">
                    <div class="shadow border-left-primary py-2">
                        <div class="card-header" style="padding: 3px;">
                            <h1 class="text-center" style="font-size: 15px;margin: 0px;color: rgb(197,159,52);width: 100%;"><br>{{$t('Common.MindProgramming')}}<br></h1>
                        </div>
                        <div class="card-body">
                            ...
                            <p v-if="MindProgrammingValue / MindProgrammingMax == 1" class="sueccess text-center">Finshed</p>
                        </div>
            ...
            <a v-if="workBook>3" class="col-md-6 col-xl-3 mb-4" @click="routTo('TeamBuilding')">
                <div class="card">
                    <img src="@/assets/img/Team-building-image-1280x640.jpeg" style="width: 100%;" height="150em">
                    <div class="shadow border-left-primary py-2">
                        <div class="card-header" style="padding: 3px;">
                            <h1 class="text-center" style="font-size: 15px;margin: 0px;color: rgb(197,159,52);width: 100%;"><br>{{$t('Common.TeamBuilding')}}<br></h1>
                        </div>
                        <div class="card-body">
                            ...
                            <p v-if="TeamBuildingValue / TeamBuildingMax == 1" class="sueccess text-center">Finshed</p>
                        </div>
