            ...
            <div v-for="item in inputToLoop" :key="item">
                <b-list-group-item>
                    <b-row>
                        ...
                        <b-col>
                            <b-form-input id="input-1" style="font-size:12px" v-model="form[item]" type="text" required placeholder=""></b-form-input>
            ...
            <b-list-group-item>
                <b-row>
                    ...
                    <b-col md="4" v-for="(item,index) in form.Countries" :key="index">
                        <b-form-input id="input-1" style="font-size:12px" v-model="form.Countries[index]" type="text" required placeholder=""></b-form-input>
            ...
            <b-list-group-item>
                <b-row>
                    <b-col md='2' v-for="item in buttonsToLoop" :key="item">
                        <b-button style="margin-bottom:10px" @click="form[item]= !form[item]" :class="{ 'btn-success': form[item]}">{{ $t("Personal_Information."+item) }}</b-button>
