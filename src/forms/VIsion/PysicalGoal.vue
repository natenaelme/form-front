                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.LongTermOne.PhysicalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.LongTermTwo.PhysicalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.MidTermOne.PhysicalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.MidTermTwo.PhysicalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.ShortTermOne.PhysicalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.ShortTermTwo.PhysicalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
