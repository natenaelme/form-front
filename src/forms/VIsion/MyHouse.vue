          ...
          <b-col>
            ...
            <b-list-group-item>
              <b-row>
                ...
                <b-col md="4" v-for="(item, index) in form.KindsOfRooms" :key="index">
                  <b-form-input
                    id="input-1"
                    style="font-size: 12px"
                    v-model="form.KindsOfRooms[index]"
                    type="text"
                    required
                    placeholder=""
                  ></b-form-input>
              ...
              <b-col style="text-align: right; padding: 0 !important">
                <b-button variant="danger" v-on:click="form.KindsOfRooms.push('')"
                  >+</b-button
                >
              </b-col>
            </b-list-group-item>
            <b-list-group-item>
              <b-row>
                ...
                <b-col md="4" v-for="(item, index) in form.InTheCompound" :key="index">
                  <b-form-input
                    id="input-1"
                    style="font-size: 12px"
                    v-model="form.InTheCompound[index]"
                    type="text"
                    required
                    placeholder=""
                  ></b-form-input>
              ...
              <b-col style="text-align: right; padding: 0 !important">
                <b-button variant="danger" v-on:click="form.InTheCompound.push('')"
                  >+</b-button
                >
              </b-col>
            </b-list-group-item>
            ...
            <b-list-group-item>
              <div class="col-sm-12">
                <label for="dropzone"
                  ><strong>{{ $t("My_House.PictureOfTheHouse") }}</strong></label
                >
                <vue-dropzone
                  ref="myVueDropzone"
                  id="dropzone"
