                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.LongTermOne.SocalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.LongTermTwo.SocalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.MidTermOne.SocalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.MidTermTwo.SocalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.ShortTermOne.SocalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.ShortTermTwo.SocalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
