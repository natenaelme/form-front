...
<div>
    ...
    <b-container cols="9">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.LongTermOne.MentalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.LongTermTwo.MentalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.MidTermOne.MentalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.MidTermTwo.MentalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.ShortTermOne.MentalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.ShortTermTwo.MentalGoal" type="text" required></b-form-input>
                            </td>
                            <td>
        ...
        <div class="position-relative row form-check">
            ...
            <div class="text-center">
                <b-button to="/question/vision_goal" variant="outline-success">
                    <b-icon icon="arrow-left"></b-icon> back
                </b-button>
                <b-button :disabled="!submited" to="/question/ensure_goal" variant="outline-success">
