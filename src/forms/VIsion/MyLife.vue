      ...
      <b-list-group>
        ...
        <b-list-group-item>
          <b-row v-for="(item, index) in form.history" :key="index">
            ...
            <b-col md="9">
              <b-form-input
                id="input-1"
                style="font-size: 12px"
                v-model="form.history[index].majorEvent"
                type="text"
                required
                placeholder=""
              ></b-form-input>
          ...
          <b-col style="text-align: right; padding: 0 !important">
            <b-button
              variant="danger"
              v-on:click="form.history.push({ year: null, majorEvent: '' })"
              >+</b-button
            >
          </b-col>
        </b-list-group-item>
