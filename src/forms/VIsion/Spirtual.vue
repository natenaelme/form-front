        ...
        <b-list-group-item>
          ...
          <b-col>
                  ...
                  <tr v-for="(item, index) in form.KindOfSpritual" :key="index">
                    <th>
                      <b-form-input
                        id="input-1"
                        style="font-size: 12px"
                        v-model="form.KindOfSpritual[index].Event"
                        type="text"
                        required
                        placeholder=""
                      ></b-form-input>
                    ...
                    <th>
                      <b-form-input
                        id="input-1"
                        style="font-size: 12px"
                        v-model="form.KindOfSpritual[index].InTheevent"
                        type="text"
                        required
                        placeholder=""
                      ></b-form-input>
                    ...
                    <th>
                      <b-form-input
                        id="input-1"
                        style="font-size: 12px"
                        v-model="form.KindOfSpritual[index].HowOften"
                        type="number"
                        required
                        placeholder=""
                      ></b-form-input>
                    ...
                    <th>
                      <b-form-input
                        id="input-1"
                        style="font-size: 12px"
                        v-model="form.KindOfSpritual[index].Cost"
                        type="number"
                        required
                        placeholder=""
                      ></b-form-input>
            ...
            <b-list-group-item>
              <div class="col-sm-12">
                <label for="dropzone"
                  ><strong>{{ $t("Spirtual.Picture") }}</strong></label
                >
                <vue-dropzone
                  ref="myVueDropzone"
                  id="dropzone"
