<template>
<div>
    <HeaderFile :FirstHeader="$t('GoalCommon.FinancialGoal')" />
    <b-container cols="9">
        <b-list-group>
            <b-row>
            ...
            <b-list-group-item>
                <b-row>
                    ...
                    <b-col md="10">
                        <input type="text" :placeholder="$t('Action_Plan.LTG')" v-model="form.LongTermOne.FinancialGoal" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        <br>
                        <input type="text" :placeholder="$t('Action_Plan.LTGT')" v-model="form.LongTermTwo.FinancialGoal" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                    </b-col>
                </b-row>
            </b-list-group-item>
            <b-list-group-item>
                <b-row>
                    ...
                    <b-col md="10">
                        <input type="text" :placeholder="$t('Action_Plan.MTG')" v-model="form.MidTermOne.FinancialGoal" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        <br>
                        <input type="text" :placeholder="$t('Action_Plan.MTGT')" v-model="form.MidTermTwo.FinancialGoal" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                    </b-col>
                </b-row>
            </b-list-group-item>
            <b-list-group-item>
                <b-row>
                    ...
                    <b-col md="10">
                        <input type="text" :placeholder="$t('Action_Plan.STG')" v-model="form.ShortTermOne.FinancialGoal" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        <br>
                        <input type="text" :placeholder="$t('Action_Plan.MTGT')" v-model="form.ShortTermTwo.FinancialGoal" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                    </b-col>
                </b-row>
            </b-list-group-item>
            <br>
            <b-list-group-item>
                <table class="table table-bordered" v-if="nextView  != 11">
                    <thead>
                        ...
                        <tr>
                            <th scope="row" colspan="2" width="50%" class="align-middle text-center" style="background-color:black;color:white;">{{ $t("GoalCommon.FinancialGoal") }}</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th width="30%">
                                <p style="width:100%;display: inline-block;">{{$t('Action_Plan.Goal')}} 1 .{{form.LongTermOne.FinancialGoal}}</p>
                            </th>
                            <th>
                        ...
                        <tr>
                            <th>
                                <p>{{$t('Action_Plan.Goal')}} 2 .{{form.LongTermTwo.FinancialGoal}}</p>
                            </th>
                            <th>
                        ...
                        <tr>
                            ...
                            <th width="30%">
                                <p style="width:100%;display: inline-block;">{{$t('Action_Plan.Goal')}} 1 .{{form.MidTermOne.FinancialGoal}}</p>
                            </th>
                            <th>
                        ...
                        <tr>
                            <th>
                                <p>{{$t('Action_Plan.Goal')}} 2 .{{form.MidTermTwo.FinancialGoal}}</p>
                            </th>
                            <th>
                        ...
                        <tr>
                            ...
                            <th width="30%">
                                <p style="width:100%;display: inline-block;">{{$t('Action_Plan.Goal')}} 1 .{{form.ShortTermOne.FinancialGoal}}</p>
                            </th>
                            <th>
                        ...
                        <tr>
                            <th>
                                <p>{{$t('Action_Plan.Goal')}} 2 .{{form.ShortTermTwo.FinancialGoal}}</p>
                            </th>
                            <th>
            ...
            <b-list-group-item class="table-responsive">
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th colspan="2" class="text-center">{{ $t("GoalCommon.Well") }}</th>
                            <th colspan="16" class="text-center">{{ $t("GoalCommon.Detail") }}</th>
                            <th colspan="5" class="text-center">{{ $t("GoalCommon.Process") }}</th>
                        </tr>
                        <tr>

                            <th scope="row" colspan="2" class="align-middle col-6" style="background-color:black;color:white">{{ $t("GoalCommon.FinancialGoal") }}</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                {{form.LongTermOne.FinancialGoal}}
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                {{form.LongTermTwo.FinancialGoal}}
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                {{form.ShortTermOne.FinancialGoal}}
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                {{form.ShortTermTwo.FinancialGoal}}
                            </td>
                            <td>
        ...
        <div class="position-relative row form-check">
            ...
            <div class="text-center">
                <b-button to="/question/use_posetive" variant="outline-success">
                    <b-icon icon="arrow-left"></b-icon> back
                </b-button>
                <b-button :disabled="!submited" to="/question/family_goal" variant="outline-success">
