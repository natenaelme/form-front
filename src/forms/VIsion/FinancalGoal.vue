                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.LongTermOne.FinancialGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.LongTermTwo.FinancialGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.MidTermOne.FinancialGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.MidTermTwo.FinancialGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.ShortTermOne.FinancialGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.ShortTermTwo.FinancialGoal" type="text" required></b-form-input>
                            </td>
                            <td>
