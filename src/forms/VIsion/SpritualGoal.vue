                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.LongTermOne.SpritualGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.LongTermTwo.SpritualGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.MidTermOne.SpritualGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.MidTermTwo.SpritualGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.ShortTermOne.SpritualGoal" type="text" required></b-form-input>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <b-form-input style="font-size:12px" v-model="form.ShortTermTwo.SpritualGoal" type="text" required></b-form-input>
                            </td>
                            <td>
