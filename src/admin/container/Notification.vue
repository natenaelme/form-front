            ...
            >
              <div v-for="(notif, index) in notificationMessages" :key="index">
                <b-card
                  ...
                  v-bind:class="{
                    active: notif.viewed_mentor,
                    notviewed: !notif.viewed_mentor,
                  }"
                >
                    ...
                    <b-row>
                      <b-col md="4">
                        <img
                          ...
                          thumbnail
                          fluid
                          :src="notif.custtomerMessage.profileImage"
                          width="40em"
                          height="40em"
                        />
                        <p>
                          {{
                            notif.custtomerMessage.firstName +
                            " " +
                            notif.custtomerMessage.lastName
                          }}
                        </p>
                      </b-col>
                      <b-col md="4">
  ...
  methods: {
    Replay() {
      ...
      let newMessage = {
        ...
        from: "mentor",
        customerId: this.currentNotificaton.customerId,
