        ...
        <b-list-group>
            ...
            <b-list-group-item>
                ...
                <b-col>
                            ...
                            <tbody>
                                <tr v-for="(item,index) in form.KindsOfMental" :key="index">
                                    <th style="background-color:white">
                                        {{form.KindsOfMental[index].Event}}
                                    </th>
                                    <th style="background-color:white">
                                        {{form.KindsOfMental[index].InTheevent}}
                                    </th>
                                    <th style="background-color:white">
                                        {{form.KindsOfMental[index].HowOften}}
                                    </th>
                                    <th style="background-color:white">
                                        {{form.KindsOfMental[index].Cost}}
                                    </th>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <b-list-group-item>
                        <div class="col-sm-12">
                            <img :src="form.PictureOfMental" width=100% class="tumbline" alt="">
                        </div>
                    </b-list-group-item>
